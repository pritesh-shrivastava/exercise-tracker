...
- [x] Keep only the last 3 backup copies in Azure Blob Storage.
- [x] Convert SQLite to CSV format before uploading to Azure Blob for portability. (Upload both .sqlite and .csv each run; prune keeps last 3 of each.)
