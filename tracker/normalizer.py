...
_CANONICAL: dict[str, str] = {
    ...
    "single arm dumbell overhead tricep extension": "Single Arm Dumbbell Overhead Tricep Extension",
    "single arm dumbbell overhead tricep extension": "Single Arm Dumbbell Overhead Tricep Extension",
    "single arm dumbell overhead triceps extension": "Single Arm Dumbbell Overhead Tricep Extension",
    "single arm dumbbell overhead triceps extension": "Single Arm Dumbbell Overhead Tricep Extension",
    "single arm dumbell overhead tricep extentions": "Single Arm Dumbbell Overhead Tricep Extension",
    "single arm dumbell overhead tricep extention": "Single Arm Dumbbell Overhead Tricep Extension",
    "single arm dumbell overhead tricep extension": "Single Arm Dumbbell Overhead Tricep Extension",
